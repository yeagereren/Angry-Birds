...
//        } else if (shapeType == ButtonShape.CIRCLE) {
//            batch.draw(buttonTexture, buttonCircle.x - buttonCircle.radius, buttonCircle.y - buttonCircle.radius,
//                buttonCircle.radius * 2, buttonCircle.radius * 2);
//        }
//    }
//
//    @Override
...
//
//        float adjustedX = x - getX();
//        float adjustedY = y - getY();
//
//        if (shapeType == ButtonShape.RECTANGLE) {
//            if (buttonBounds.contains(adjustedX, adjustedY)) {
//                return this;
//            }
//        } else if (shapeType == ButtonShape.CIRCLE) {
//            if (buttonCircle.contains(adjustedX + buttonCircle.x, adjustedY + buttonCircle.y)) {
//                return this;
//            }
//        }
//
